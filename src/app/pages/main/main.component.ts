...
export class MainComponent implements OnInit {
  ...
  constructor(private dataservice: ApiService ,public filter:filter2 ) {}
...
// console.log($e);
    ...
    this.dataservice.search(// search vine din recipes.service.ts unde returneaza  parte din site pentru a putea folosi tabloul 
      // $e este tabloul cu parametri
      this.filter.transformToQuery($e)) //transformToQuery vine din filter2 !
